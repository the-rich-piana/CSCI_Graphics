...
static void drawXYPlane(double grid_length, double h){
...
void display()
{
   ...
   float Position[]  = {distance*Cos(zh), ylight,distance*Sin(zh), .5};
   glColor3f(1,1,1);
   ...
   drawCylinder(0, -1, 2, 1, 5, 1, 0 );
   drawCylinder(2, -1, 0, 1, 5, 1, 0 );
   drawCylinder(2, -1, -2, 1, 5, 1, 0 );
   drawCylinder(-2, -1, -2, 1, 5, 1, 0 );
   drawCylinder(2, -1, 2, 1, 5, 1, 0 );
   drawCylinder(-2, -1, 2, 1, 5, 1, 0 );
   drawCylinder(0, -1, -2, 1, 5, 1, 0 );
